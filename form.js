/* ===========================================================
   ...
   -----------------------------------------------------------
   과외·공부의온도·채용·데일리카네기·서포트포스와 같은 **공용 웹앱 하나**로 보냅니다 (총 6개 사이트).
   ...
   ⚠️ 탭 이름 "키즈 튜터" 는 띄어쓰기 포함. 배포된 스크립트에 허용 탭 목록이 없어서
     여기 값이 그대로 탭 이름이 됩니다 → 오타 나면 기본 탭으로 안 가고 새 탭이 조용히 생김.
     (2026-09-03 실제 제출 테스트로 "키즈 튜터" 탭 정상 도착 확인)
     실제 스크립트는 구글 서버에 있음. 참고 사본: google-apps-script.gs
   =========================================================== */
